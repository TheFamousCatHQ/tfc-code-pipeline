...
class SonarScannerProcessor(CodeProcessor):
    ...
    def add_arguments(self, parser: argparse.ArgumentParser) -> None:
        ...
        parser.add_argument(
            ...
            help="SonarQube host URL (default: http://localhost:9000)"
        )
        parser.add_argument(
            "--login",
            type=str,
    ...
    def get_default_message(self) -> str:
        ...
        """
        # This processor doesn't use aider, but we need to implement this method
        return "Running sonar-scanner on the codebase."
